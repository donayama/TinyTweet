...
//        var val = webView.evalJS("document.getElementById('oauth_pin').innerHTML");
        var val = webView.evalJS("document.getElementsByTagName('code')[0].innerHTML");
        if( val ){
          pin = val;
    ...
    this.showAuthorizeUI = function(pUrl, pReceivePinCallback)
    {
        ...
        webView = Ti.UI.createWebView({
            ...
            width: view.width - view.borderWidth * 4,
	...
	// PostParameters for TwitPic
	this.getParamatersForTwitPic = function(pKey){
		return {
			key: pKey,
			consumer_token: pConsumerKey,
			consumer_secret: pConsumerSecret,
